            ...
            <tbody className=''>
                {GoodReceivedData.map((sup)=>(
                    <tr key={sup.id} className="border-b border-gray-200 hover:bg-gray-200 hover:scale-101 transition-all scrollbar-none ">
                        <td className="px-6 py-4"><span className='text-blue-800'>{sup.grnNo}</span> </td>
                        <td className="px-6 py-4">{sup.id}</td>
                        <td className="px-6 py-4">{sup.supplier}</td>
                        <td className="px-6 py-4">{sup.receivedDate}</td>
                        <td className="px-6 py-4">{sup.totalItems}</td>
                        <td className="px-6 py-4">
                            <span className='bg-green-200 ms-4 px-3 py-1 text-green-800 rounded-md'>
                                {sup.totalQty}
                            </span>
                        </td>
                        <td className="px-6 py-4"><span className=''>{sup.totalValue}</span></td>
                        <td className="px-6 py-4"><span className=''>{sup.totareceivedBylValue}</span></td>
                        <td className="px-6 py-4"><span className=''>{sup.status}</span></td>
                        <td className="px-6 py-4">
