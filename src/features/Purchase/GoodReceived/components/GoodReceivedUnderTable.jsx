...
function GoodReceivedUnderTable() {
  const products = [
    {
      id: 1,
    ...
    <div className="w-full border border-gray-200 rounded-lg overflow-hidden bg-white mt-5 ">
      ...
      <div className="overflow-x-auto hidden-scroll">
        ...
        <div className="flex pl-200 justify-between px-5 mb-5">
              <h1 className="font-bold text-gray-700">Total Value</h1>
              <h1 className="text-blue-800 font-bold">$2555.00</h1>
          </div>
      </div>
    </div>
  );
...
export default GoodReceivedUnderTable;